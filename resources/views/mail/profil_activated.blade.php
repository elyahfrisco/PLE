                        ...
                        <div
                          ...
                          <p class="text-build-content" style="text-align: center; margin: 10px 0; margin-top: 10px;"
                            data-testid="KtWjoB-VjqyjkXDsekX8O"><span
                              style="color:#0c5d89;font-family:Verdana;font-size:20px;line-height:20px;"><b>Félicitation
                                !</b></span></p>
                          <p class="text-build-content" style="text-align: center; margin: 10px 0;"
                            data-testid="KtWjoB-VjqyjkXDsekX8O"><span
                              style="color:#0c5d89;font-family:Verdana;font-size:20px;line-height:20px;"><b>Vous êtes
                                maintenant client(e) de PLE.</b></span><br><span
                              style="color:#0c5d89;font-family:Verdana;font-size:20px;line-height:20px;"><b>Vous avez
                                souscrit aux activités suivantes :</b></span><br>&nbsp;</p>
                                @foreach ($wishes as $wishe)
        <li> <strong>{{ strtoupper($wishe['activity']['name']) }}</strong>: {{ $wishe['dayFr'] }} {{ $wishe['time_start'] }} à {{ $wishe['time_end'] }}</li>
    @endforeach
