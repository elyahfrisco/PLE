  ...
  <table class="table" v-if="wishes.length">
    ...
    <tbody>
      <template v-for="(wish, i) in wishes" :key="i">
        ...
        >
          <td>{{ wish.establishment_id ? wish.establishment_id : "-" }}</td>
          <td>{{ wish.activity_id ? wish.activity_id : "-" }}</td>
          <td>{{ wish.day ? dayfr(wish.day) : "-" }}</td>
          <td>
            {{ wish.time_start ? wish.time_start : "-" }} -
            {{ wish.time_end ? wish.time_end : "-" }}
          </td>
          <td>{{ wish.planning_id ? wish.planning_id : "-" }}</td>
          <td>
            <button
